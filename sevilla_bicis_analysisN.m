...
% =========================================================================
% MODELO 1: PAGERANK CLÁSICO (Todos los nodos valen lo mismo)
% =========================================================================
...
% =========================================================================
% MODELO 2: PAGERANK PERSONALIZADO (Atención a SEVici)
% =========================================================================
% 12 NODOS SEVICI IMPORTANTES
nodos_sevici = [7,11,21,25,26,28,30,32,50,58,59,63];

v2 = zeros(N, 1);
v2(nodos_sevici) = 1; % Le damos todo el "peso" inicial a las paradas top
